# Exercise 2: Q&A, with a database
...
| questioner info (object containing the user's email as string and id as integer) |
| posting date (datejs) |
...
| id (int) |
| answer text (string) |
| respondent info (object containing the user's email as string and id as integer) |
| posting date (datejs) |
